import { OoxmlProcessor } from './ooxmlProcessor';
...
export function testMergeFieldProcessing(): void {
...
export function testIfFieldProcessing(): void {
...
export function testWithRealSamples(): void {
